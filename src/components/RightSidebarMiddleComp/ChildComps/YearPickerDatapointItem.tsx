...
interface YearPickerDatapointItemProps {
    datapoint: any;
    activeFieldData: any;
    fieldDataValues: any;
    inputRefs: any;
...
const YearPickerDatapointItem: React.FC<YearPickerDatapointItemProps> = ({
    ...
    useEffect(() => {
        if (value && moment(value, 'YYYY').isValid()) {
            form.setFieldsValue({
                [field_data_id]: moment(value, 'YYYY'),
            });
        } else {
            form.setFieldsValue({
                [field_data_id]: null,
    ...
    useEffect(() => {
        ...
        if (moment(fieldDataValue, 'YYYY').isValid()) {
            form.setFieldsValue({
                [field_data_id]: moment(fieldDataValue, 'YYYY'),
            });
        } else {
            form.setFieldsValue({
                [field_data_id]: null,
...
export default React.memo(YearPickerDatapointItem);
